...
public class ActividadArrays {
    ...
    public static void main(String[] args) {
        ActividadArrays programa = new ActividadArrays();
        programa.iniciar();
    }
    ...
    private void iniciar() {
        ...
        System.out.println("Números: " + Arrays.toString(listaNumeros));
        System.out.println("Palabras: " + Arrays.toString(listaPalabras));
        System.out.println("Vacía: " + Arrays.toString(listaVacia));
